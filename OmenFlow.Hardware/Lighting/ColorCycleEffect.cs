...
public class ColorCycleEffect : IEffect
{
    public string Name => "ColorCycle";
    ...
    public ColorCycleEffect(double speed = 0.2, double brightness = 1.0)
    {
        _speed = speed;
    ...
    public void Update(TimeSpan deltaTime)
    {
        ...
        double hue = (_elapsedSeconds * _speed) % 1.0;
        if (hue < 0) hue += 1.0;
